...
class ZFDebug_Controller_Plugin_Debug_Plugin_Time extends Zend_Controller_Plugin_Abstract implements ZFDebug_Controller_Plugin_Debug_Plugin_Interface
{
    ...
    {
        $html = '<h4>Compteurs personnalisés</h4>';
        ...
        $html .= '<br />Pour remettre à zéro les compteurs, passer ZFDEBUG_RESET en paramètre GET/POST';
    ...
    {
        if(!is_array($array)) {
            return 'ERREUR dans la méthode _calcAvg(): ce n\'est pas un tableau';
        }
